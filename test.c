...
/*
Aquí tenemos funciones para comprobar el correcto funcionamiento del programa.
*/
...
/*esta función nos permite comprobar el generador de movimientos contando el número de nodos totales
...
/*esta función resuelve 25 posiciones (WAC) durante 20 segundos, se puede utilizar si vamos a
realizar un profile guided optimization del ejecutable*/
void Test(void)
{
	tiempo_total = 20000;
...
/*esta función resuelve un mate en 7, nos sirve para comprobar la velocidad relativa del
ordenador respecto a uno determinado, también para comporar por ejemplo diferentes compilaciones
del código con diferentes compiladores*/
void bench(void)
{
	int i, t;
	double nps[2], npst;
